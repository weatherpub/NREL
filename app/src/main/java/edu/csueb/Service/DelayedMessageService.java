...
public class DelayedMessageService extends IntentService {
    ...
    public static final String EXTRA_MESSAGE = "Trans Women";

    @Override
    protected void onHandleIntent(Intent intent) {
        Log.i("log", "onHandleIntent(Intent intent)");

        synchronized (this) {
            try {
                wait(10000);
                Log.i("log", "synchronized(this)");
    ...
    public void showText(final String name) {
        Log.i("ShowText => ", name);
    }
